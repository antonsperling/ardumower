  ...
  for(address = 1; address < 127; address++ )
  {
      ...
      if (error == 0)
      {
        ...
        switch (address){          
          ...
          case 0x68: Console.print("probably DS1307 or MPU9250 on AD0"); break;
          case 0x69: Console.print("probably MPU6050/9150 or L3G4200D or MPU9250 on AD1"); break;          
          case 0x77: Console.print("probably BMP180"); break;      
          case AK8963_ADDRESS: Console.print("probably AK8963 aka Magnetometer on MPU9250"); break;            
