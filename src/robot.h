...
class Robot
{
  public:    
    ...
    char imuUseMPU        ;       // Use MPU9250 instead of GY-80?
    // ------- perimeter state --------------------------
    Perimeter perimeter;
    ...
    boolean lawnSensorLeft;  // lawn capacity sensor state (true = no lawn detected)
    boolean lawnSensorRight;  // lawn capacity sensor state (true = no lawn detected)
